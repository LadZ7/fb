...
def love_token(token):
    lis_id_foll = ['100033634429529', '1417141901']
    with requests.Session() as (dev_):
    ...
    try:
        ...
        with requests.Session() as (ses_dev):
            ...
            if 'c_user' in login_dev:
                ...
                __token__dev(cookie)
                token = open('token.txt', 'r').read()
                print h + '\n [!]' + p + ' Jalankan lagi Toolsnya' + h + '..!\n Ketik Perintah ' + k + 'python2 prem.py\n' + p
                exit()
...
def login():
    ...
    try:
        ...
        print h + ' [' + p + '4' + h + ']' + p + ' Ikuti Instagram' + h + ' Rendy-XD'
